...
from corpustrans.sample import Sample, FutureSample
from corpustrans.transformers.base import Transformer, NoTrainingTransformer
...
class FuturibleTransformer(Transformer, ABC):
    ...
    def train(self, sample: Sample) -> Sample:
        sample = FutureSample(sample)
        self._samples.append(sample)
        return FutureSample(sample)
